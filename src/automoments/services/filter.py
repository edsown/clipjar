...
class MotionDetector:
    ...
    def has_motion(self, video_path, sample_frames=30):
    ...
    def filter_clips_with_motion(self, clip_paths):
        active_clips = []
        for path in clip_paths:
            if self.has_motion(path, motion_threshold=self.motion_threshold):
